...
public class DriverTest
{
    ...
    public static void main (String args[]){
        ...
        while(project.run) {
            ...
            if(inputFileName.equals("Exit.txt") || inputFileName.equals("exit.txt")) {
                //if the file name is Exit then the program will exit
                System.out.println();   //line break
                System.out.print("\t" + "Exiting...");
                project.run = false;
            }
            else if(inputFileName.equals("viewlog.txt")) {
